# -*- coding: utf-8 -*-
#
# SQLAlchemy-Future documentation build configuration file, created by
...
htmlhelp_basename = 'SQLAlchemy-Futuredoc'
...
latex_documents = [
  ('index', 'SQLAlchemy-Future.tex', u'SQLAlchemy-Future Documentation',
...
man_pages = [
    ('index', 'sqlalchemy-future', u'SQLAlchemy-Future Documentation',
     [u'Hong Minhee'], 1)
]
